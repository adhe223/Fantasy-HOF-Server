...
ReactDOM.render(
    <div>
        {/*
                <BarChart chartName="winsChart" chartLabels={winsChart.labels} chartDataset={winsChart.dataset}
                          chartDatasetLabel={winsChart.datasetLabel}/>
        ...
        */}
        <MatchupPage owners={leagueData.owners} />
    </div>,
